...
const PhotographyApp: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center bg-gray-50 p-8">
      {!selectedCategory ? (
        <>
          <h1 className="text-5xl font-bold text-[#01689c] mb-6">{session.user.institutionName}</h1>
            ...
            {photographyCategories.map((categoryItem) => {
              ...
              return (
                <div
                  ...
                  className="bg-white shadow-sm rounded-sm p-6 cursor-pointer hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300 border border-gray-200 hover:border-blue-500"
                  onClick={() => {
                ...
                >
                  ...
                  ) : filteredServices.length > 0 && (filteredServices[0]?.images?.length ?? 0) > 0 ? (
                    <>
                      <img
        ...
        <>
          ...
          <img
            ...
            className="w-full max-w-lg h-64 object-cover rounded-sm shadow-sm"
          />
          <div className="mt-6 flex space-x-4">
            ...
            <button
              className={`px-6 py-3 rounded-sm text-white ${
          ...
          {orderType === 'SOFT_COPY' && (
            <div className="mt-4 w-full max-w-lg">
              <input
                ...
                className="mt-4 p-2 border rounded-sm w-full"
              />
              <input
                type="text"
          ...
          <button
            ...
            className="mt-6 px-8 py-4 bg-blue-600 text-white rounded-sm shadow-md hover:bg-blue-700 transition-all transform hover:scale-105"
          >
            Submit Order
          </button>
        </>
